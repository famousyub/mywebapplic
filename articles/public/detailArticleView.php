                    ...
                    <p>
                        ...
                        if (!empty($recup["theimages_name"])):
                            ...
                            foreach ($arrayImgName as $img):
                                ?>
                                <a href='<?=IMG_UPLOAD_MEDIUM . $img?>' data-lightbox="example-set-<?=$recup["idarticles"]?>" title="<?= $arrayImgTitle[$i] ?>"><img src="<?= IMG_UPLOAD_SMALL . $img ?>" alt="<?= $arrayImgTitle[$i] ?>" height="120" width="150"/></a>
                                <?php
                                $i++;
                            endforeach;
                        endif;
