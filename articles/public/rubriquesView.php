                        ...
                        <p>
                            ...
                            if (!empty($item["theimages_name"])):
                                ...
                                foreach ($arrayImgName as $img):
                                    ?>
                                    <a href='<?=IMG_UPLOAD_MEDIUM . $img?>' data-lightbox="example-set-<?=$item["idarticles"]?>"><img class="img responsive" src="<?= IMG_UPLOAD_SMALL . $img ?>" alt="<?= $arrayImgTitle[$i] ?>" height="120" width="150"/></a>
                                    <?php
                                    $i++;
                                endforeach;
                            endif;
